...
@interface LeqiAnalyticsSDK : NSObject
...
@return 返回单例
*/
+ (LeqiAnalyticsSDK *)sharedInstance;
...
#pragma mark - Track
@interface LeqiAnalyticsSDK (Track)
...
- (void)track:(NSString *)eventName properties:(nullable NSDictionary *)properties elementproperties:(nullable NSDictionary *)elementproperties;
/**
 * @abstract
 * 调用 track 接口，追踪一个无私有属性的 event
 *
 * @param eventName event 的名称
 */
...
#pragma mark - Timer
@interface LeqiAnalyticsSDK (Timer)
