...
{
    // 弹出的整个视图
    _wholeView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, pickViewHeight)];
...
- (void)showBottomView
{
    ...
    {
        _wholeView.frame = CGRectMake(0, ScreenHeight-pickViewHeight, ScreenWidth, pickViewHeight);
...
- (void)hiddenBottomView
{
    [UIView animateWithDuration:0.3 animations:^
    {
        _wholeView.frame = CGRectMake(0, ScreenHeight, ScreenWidth, pickViewHeight);
