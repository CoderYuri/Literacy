//
//  BTNoneProgressPlayerControlView.m
//  bangtoushuke
//
//  Created by youlian on 8/10/20.
//  Copyright © 2020 bangTouShuKe. All rights reserved.
//
...
@interface BTNoneProgressPlayerControlView ()
/// 竖屏控制层的View
...
@end
@implementation BTNoneProgressPlayerControlView
...
- (ZFPortraitControlView *)portraitControlView {
    if (!_portraitControlView) {
        ...
        _portraitControlView.currentTimeLabel.hidden = YES;
        _portraitControlView.slider.hidden = YES;
        _portraitControlView.totalTimeLabel.hidden = YES;
        _portraitControlView.fullScreenBtn.hidden = YES;
